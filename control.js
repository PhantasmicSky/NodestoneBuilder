...
function buildPerfectTri() {
    ...
    var comboMessage = selectedJob + "||| " + JSON.stringify(nodestones) + "||| " + JSON.stringify(nodeCollection) + "||| " + JSON.stringify(selectedSkills) + "||| " + skillCopy;
...
function modalCookie(userSel){
    if(userSel == true){
        document.cookie = "nodeStoneShowModal=false";
        document.cookie = "nodeStoneVersion="+appVer;
    }
    else{
        document.cookie = "";
    }
